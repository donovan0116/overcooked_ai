...
if __name__ == "__main__":
    ...
    layout = "cramped_room"
    param.set('bc_data_addr_train', f'./human_data/{layout}/2019_hh_trials_train_{layout}.pt')
    param.set('bc_data_addr_test', f'./human_data/{layout}/2019_hh_trials_test_{layout}.pt')
